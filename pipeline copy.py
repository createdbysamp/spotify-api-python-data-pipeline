...
#     parser.add_argument('--artist', type=str, required=True, help='The name of the artist to search for.')
#     parser.add_argument('--db', type=str, default='data.db', required=True, help="the name of the db to save to!")
#     parser.add_argument('--table', type=str, default='etl_output', help="the name of the SQLite table to load the data into.")
...
# # main ------------------------------------------------------------------|
# def main(artist_aname, db_name, table_name):
#     token = get_token()
